...
class ListeningPart(Base):
    ...
    section_id = Column(Integer, ForeignKey("test_sections.id"))
...
class ListeningQuestion(Base):
    ...
    question_type = Column(String, nullable=False)  # From QuestionTypeEnum
    ...
    image_url = Column(String, nullable=True)  # For map/diagram questions
...
class WritingTask(Base):
    ...
    task_type = Column(String, nullable=False)  # From QuestionTypeEnum
    prompt_text = Column(Text, nullable=False)
    image_url = Column(String, nullable=True)  # For Task 1 Academic (graphs/charts)
